...
object Schemas {
  ...
  /** @see [[BadRow.LoaderParsingErrors]] */
  ...
  /** @see [[BadRow.LoaderRuntimeErrors]] */
  ...
  /** @see [[BadRow.BQRepeaterPubSubError]] */
  ...
  /** @see [[BadRow.BQRepeaterBigQueryError]] */
  val BQRepeaterBigQueryError = SchemaKey("com.snowplowanalytics.snowplow.badrows", "bq_repeater_bigquery_error", "jsonschema", SchemaVer.Full(1, 0, 0))
}
